...
import 'package:relife/ui/pages/accountability/upadte_accountability.dart';
...
class UpdatePlanRoutinePage extends StatefulWidget {
  final Detail detail;
  const UpdatePlanRoutinePage({Key? key, required this.detail})
      : super(key: key);

  @override
  State<UpdatePlanRoutinePage> createState() => _UpdatePlanRoutinePageState();
}

class _UpdatePlanRoutinePageState extends State<UpdatePlanRoutinePage> {
  @override
  void initState() {
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      final updateHabit =
          Provider.of<UpdateHabitsProvider>(context, listen: false);
      updateHabit.setReward(widget.detail.reward);
      updateHabit.setExactBehaviour(widget.detail.exactBehaviour);
      updateHabit.setReminderHabit(widget.detail.reminderHabit);
      // String remainderTime() {
      //   int hour = 0;
      //   int min = 0;
      //   String amPm = 'AM';
      //   if (widget.detail.reminderTime / 100 > 12) {
      //     hour = (widget.detail.reminderTime ~/ 100) - 12;
      //     min = (widget.detail.reminderTime) % 100;
      //     amPm = 'PM';
      //   } else {
      //     hour = widget.detail.reminderTime ~/ 100;
      //     min = (widget.detail.reminderTime) % 100;
      //   }
      //   return '$hour:$min $amPm';
      // }

      // final time = remainderTime();
      updateHabit.setReminderTime(widget.detail.reminderTime.toString());
      DateTime? newTime = DateTime.fromMillisecondsSinceEpoch(
          int.parse(updateHabit.reminderTime));
      ...
      // updateHabit.setReminderDays(widget.detail.reminderDays);
      // _days = [
      //   DayInWeek("SUN",
      //       isSelected: widget.detail.reminderDays[0] == 0 ? false : true),
      //   DayInWeek("MON",
      //       isSelected: widget.detail.reminderDays[1] == 0 ? false : true),
      //   DayInWeek("TUE",
      //       isSelected: widget.detail.reminderDays[2] == 0 ? false : true),
      //   DayInWeek("WED",
      //       isSelected: widget.detail.reminderDays[3] == 0 ? false : true),
      //   DayInWeek("THR",
      //       isSelected: widget.detail.reminderDays[4] == 0 ? false : true),
      //   DayInWeek("FRI",
      //       isSelected: widget.detail.reminderDays[5] == 0 ? false : true),
      //   DayInWeek("SAT",
      //       isSelected: widget.detail.reminderDays[6] == 0 ? false : true),
      // ];
    });
              ...
              children: [
                ...
                _buildParagraph(
                  ...
                  onTap: () => buildBottomSheetRecommendation(
                    ...
                    recommended: widget.detail.habitDetails.reminderHabits,
                ...
                _buildParagraph(
                  ...
                  onTap: () => buildBottomSheetRecommendationExactBehaviour(
                    ...
                    recommended: widget.detail.habitDetails.exactBehaviour,
                  ),
                ),
                SizedBox(
                  height: 22.0.h,
                ...
                _buildParagraph(
                    message: DateFormat('hh:mm a').format(
                        DateTime.fromMillisecondsSinceEpoch(int.parse(
                            addHabit.reminderTime))), //addHabit.reminderTime.,
                    onTap: () async {
                      DateTime? newTime = DateTime.fromMillisecondsSinceEpoch(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: CustomTextButton(
                                ...
                                elevation: 0,
                                onTap: () async {
                                  addHabit.setReminderTime(newTime!
                                      .millisecondsSinceEpoch
                                      .toString());
                                  addHabit.updateHabitRequestModel
                                          .reminderTime =
                                  ...
                                  // print("alarm : ${days}");
                                  // print(
                                  //     "alarm : ${alarmProvider.getListOfweekDaysAlarm()}");
                                  List<int> daysList =
                                      alarmProvider.getListOfweekDaysAlarm();
                                  //print(daysList);

                                  if (daysList.every((element) =>
                                  ...
                                  // print(addHabit
                                  //     .updateHabitRequestModel.reminderDays);

                                  // print(DateTime.fromMillisecondsSinceEpoch(
                                  //     int.parse(addHabit.updateHabitRequestModel
                                  //         .reminderTime)));
                ...
                _buildButton(context, widget.detail),
              ],
            ),
          );
        },
  ...
  Padding _buildButton(BuildContext context, Detail detail) {
    return Padding(
      ...
      child: CustomTextButton(
        ...
        onTap: () {
          final updateHabits =
              Provider.of<UpdateHabitsProvider>(context, listen: false);
          updateHabits.setHabitDetails(detail.habitDetails.id);

          navigatorPush(
            context,
            UpadteAccountabilityPage(
              detail: detail,
            ),
          );
        },
